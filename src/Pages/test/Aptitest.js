...
function Aptitest({id}) {
    const subtests = [
        { id: 1, name: 'Liguistic Reasoning' },
        { id: 2, name: 'Numerical Reasoning' },
        { id: 3, name: 'Mechanical Reasoning' },
        { id: 4, name: 'Abstract Reasoning' },
        { id: 5, name: 'Spatial Reasoning' },
        { id: 6, name: 'Logical Reasoning' },
      ];
  return (
    <div className="bg-white min-h-screen p-10">
      <h1 className="text-2xl font-bold text-black mb-8">Aptitude Test</h1>
